...
<TITLE>501 Not Implemented « SKGB</TITLE>
<STYLE TYPE="text/css">
...
<H2><IMG SRC="//servo.skgb.de/images/StopAlert.png" WIDTH="64" HEIGHT="64" ALT="Fehler:" STYLE="float: right"> Nicht implementiert</H2>
<P>Der von dir angeforderte Zugriff auf die Adresse <B><?php echo htmlspecialchars($_SERVER['REQUEST_URI']); ?></B> per <B><?php echo htmlspecialchars($_SERVER['REQUEST_METHOD']); ?></B> wird von diesem Server nicht unterstützt.
<ADDRESS><?php echo $_SERVER['SERVER_SIGNATURE']; ?></ADDRESS>

<P STYLE="margin-top: 2em">Wenn du der Meinung bist, dass der Zugriff auf diese Adresse per <?php echo htmlspecialchars($_SERVER['REQUEST_METHOD']); ?> möglich sein sollte, melde das Problem bitte dem Vereinsvorstand (→ <A HREF="/kontakt">Kontakt</A>).
