...
<P ID="copyright">© 1999–<?php echo date('Y'); ?> <ABBR TITLE="Segel- und Kanugemeinschaft Bruchertalsperre e. V.">SKGB</ABBR> · <A HREF="mailto:info&#064;skgb.de">info&#064;skgb.de</A> · <?php wp_register('', ' ·'); ?> <?php wp_loginout(); ?>
