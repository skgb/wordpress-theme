...
<H3 ID="comments"><?php comments_number('Kommentare', '1 Kommentar', '% Kommentare'); ?></H3>
...
<P CLASS="address" ID="respond"><?php printf(__('Logged in as %s.'), '<A HREF="'.get_option('siteurl').'/wp-admin/profile.php">'.$user_identity.'</A>'); ?> <A HREF="<?php echo wp_logout_url(get_permalink()); ?>" title="<?php _e('Log out of this account') ?>"><?php _e('Log out &raquo;'); ?></A></P>

<?php else : ?>

<?php if (! $req) echo '<P>Alle Angaben sind freiwillig.</P>'; ?>

<P><LABEL><INPUT TYPE="text" NAME="author" VALUE="<?php echo $comment_author; ?>" SIZE="22" TABINDEX="1"> Vorname</LABEL></P>
